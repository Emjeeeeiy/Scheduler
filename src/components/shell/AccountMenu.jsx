...
import { InboxIcon, ListIcon, LogOutIcon, PlusIcon, SettingsIcon, TagIcon, UserIcon } from '../icons.jsx'
import { ProfileModal } from './ProfileModal.jsx'

const PANEL_WIDTH = 190
// Sized for the mobile row count below (New task/To-do/Tags/All items/
// Settings, a divider, Account, Log out) — this only feeds the
// open-upward-or-downward decision in usePopoverPlacement, never an actual
// CSS max-height, so it being generous on desktop (where those five rows are
// hidden and the panel is genuinely shorter) costs nothing.
const PANEL_MAX_HEIGHT = 316
 ...
 *
 * New task/To-do/Tags/All items/Settings are also always in this markup, but
 ...
 * all five directly, these rows are simply never visible.
 */
export function AccountMenu({ onNewTask, onOpenTodo, onOpenTags, onOpenItems, onOpenSettings }) {
