/* index.html's boot splash (brand mark + animated Cadence title) is dismissed
 * by React on first paint. These tests prove the handoff: the splash fades
 * via CSS and is then removed, reduced-motion skips the fade, and a second
 * call (or a page without the splash) is a safe no-op.
 */
